...
// import { IResetPasswordOtpUseCase } from '@/application/interfaces/IUserPasswordUseCases';
...
//         firstName: user.firstName,lastName:user.lastName, email: user.email, password: user.password, otp,
//       });
